        ...
        <main class="space-y-6">
            <section class="rounded-3xl bg-white p-6 shadow-lg shadow-slate-200/80">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-pink-200 shadow-sm shadow-pink-100">
                        <thead class="bg-pink-100">
                            <tr>
                                <th class="px-4 py-3 text-left text-sm font-semibold uppercase tracking-[0.12em] text-pink-700">Nama</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold uppercase tracking-[0.12em] text-pink-700">Usia</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold uppercase tracking-[0.12em] text-pink-700">No HP</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold uppercase tracking-[0.12em] text-pink-700">Kota</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-pink-200 bg-white">
